 ...
 *
 * Usage:
 *   PRIVATE_KEY=0x... KYBERSWAP_API_KEY=... ts-node scripts/e2e/swap/kyberswap.postFee.balanceOf.ts
 */
 ...
 * for balanceOf delta measurement and post-fee deduction.
 */
...
async function main() {
  ...
  logTxnSummary(
    `Polygon AAVE → USDC — kyberswap postFee/balanceOf`,
    CHAIN_IDS.POLYGON,
    receipt,
  );
