 ...
 *
 * Usage:
 *   PRIVATE_KEY=0x... ts-node scripts/e2e/stargate/swapAndBridge.postFee.balanceOf.ts
 */
...
// post-fee (0x01) | balance-of (0x02) | bridge-value (0x04): forward finalETH as msg.value
const FLAGS = 0x03n | BRIDGE_VALUE_FLAG;
