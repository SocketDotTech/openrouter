...
const config: HardhatUserConfig = {
  ...
  networks: {
    ...
    // testnets
    arbitrumSepolia: {
      url: process.env.ARBITRUM_SEPOLIA_RPC ?? "https://arbitrum-sepolia-rpc.publicnode.com",
      chainId: 421614,
      accounts,
    },
    optimismSepolia: {
    ...
    customChains: [
      {
        network: "ethereum",
        chainId: 1,
        urls: { apiURL: "https://api.etherscan.io/v2/api?chainid=1", browserURL: "https://etherscan.io" },
      },
      {
        network: "optimism",
        chainId: 10,
        urls: { apiURL: "https://api.etherscan.io/v2/api?chainid=10", browserURL: "https://optimistic.etherscan.io" },
      },
      {
        network: "bsc",
        chainId: 56,
        urls: { apiURL: "https://api.etherscan.io/v2/api?chainid=56", browserURL: "https://bscscan.com" },
      },
      {
        network: "polygon",
        chainId: 137,
      ...
      },
      {
        network: "mantle",
        chainId: 5000,
        urls: { apiURL: "https://api.etherscan.io/v2/api?chainid=5000", browserURL: "https://mantlescan.xyz" },
      },
      {
        network: "arbitrumOne",
        chainId: 42161,
        urls: { apiURL: "https://api.etherscan.io/v2/api?chainid=42161", browserURL: "https://arbiscan.io" },
      },
      {
        network: "avalanche",
        chainId: 43114,
        urls: { apiURL: "https://api.etherscan.io/v2/api?chainid=43114", browserURL: "https://snowscan.xyz" },
      },
      {
        network: "linea",
        chainId: 59144,
        urls: { apiURL: "https://api.etherscan.io/v2/api?chainid=59144", browserURL: "https://lineascan.build" },
      },
      {
        network: "base",
        chainId: 8453,
      ...
      },
      {
        network: "gnosis",
        chainId: 100,
        urls: { apiURL: "https://api.etherscan.io/v2/api?chainid=100", browserURL: "https://gnosisscan.io" },
      },
      {
        network: "blast",
        chainId: 81457,
        urls: { apiURL: "https://api.etherscan.io/v2/api?chainid=81457", browserURL: "https://blastscan.io" },
      },
      {
        network: "scroll",
        chainId: 534352,
        urls: { apiURL: "https://api.etherscan.io/v2/api?chainid=534352", browserURL: "https://scrollscan.com" },
      },
      {
        network: "mode",
        chainId: 34443,
        urls: { apiURL: "https://explorer.mode.network/api", browserURL: "https://explorer.mode.network" },
      },
      {
        network: "sonic",
        chainId: 146,
      ...
      },
      {
        network: "unichain",
        chainId: 130,
        urls: { apiURL: "https://api.etherscan.io/v2/api?chainid=130", browserURL: "https://uniscan.xyz" },
      },
      {
        network: "berachain",
        chainId: 80094,
        urls: { apiURL: "https://api.etherscan.io/v2/api?chainid=80094", browserURL: "https://berascan.com" },
      },
      {
        network: "ink",
        chainId: 57073,
      ...
      },
      {
        network: "worldchain",
        chainId: 480,
        urls: { apiURL: "https://api.etherscan.io/v2/api?chainid=480", browserURL: "https://worldscan.org" },
      },
      {
        network: "sei",
        chainId: 1329,
        urls: { apiURL: "https://seitrace.com/pacific-1/api", browserURL: "https://seitrace.com" },
      },
      {
      ...
      },
      {
        ...
        chainId: 11155420,
        urls: { apiURL: "https://api-sepolia-optimistic.etherscan.io/api", browserURL: "https://sepolia-optimism.etherscan.io" },
      },
    ],
  },
  typechain: {
